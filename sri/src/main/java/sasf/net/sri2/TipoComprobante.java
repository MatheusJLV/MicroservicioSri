...
public class TipoComprobante {
	...
	public TipoComprobante(int codigo, int codigoInstitucionControl, String descripcion) {
	...
	public TipoComprobante(int codigo, int codigoInstitucionControl, String descripcion, String estado,
	...
	public String toString() {
		return "TipoComprobante [codigo=" + codigo + ", codigoInstitucionControl=" + codigoInstitucionControl
