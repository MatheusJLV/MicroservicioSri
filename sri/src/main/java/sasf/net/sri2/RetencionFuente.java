...
public class RetencionFuente {
	...
	public RetencionFuente(int codigo, String descripcion) {
		super();
		this.codigo = codigo;
	...
	public RetencionFuente(int codigo, int codigoInstitucionControl, String descripcion, String estado,
	...
	public String toString() {
		return "RetencionFuente [codigo=" + codigo + ", codigoInstitucionControl=" + codigoInstitucionControl
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RetencionFuente other = (RetencionFuente) obj;
