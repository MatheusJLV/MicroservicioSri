...
import sasf.net.sri.utils.*;
@Entity
public class RetencionFuentePorcentaje {
	public static SimpleDateFormat formatter = new SimpleDateFormat("dd/MM/yyyy"); 
	@NotNull
	private int sriRetFuCodigo;
	...
	public RetencionFuentePorcentaje(String descripcion) {
		super();
	...
	public RetencionFuentePorcentaje() {
		super();
	}
	public RetencionFuentePorcentaje(int sriRetFuCodigo, int codigo, int codigoInstitucionControl, String descripcion,
			int porcentaje, int deCada, int valor, Date fechaDesde, Date fechaHasta, String estado, Date fechaEstado,
		...
		super();
		this.sriRetFuCodigo = sriRetFuCodigo;
		this.codigo = codigo;
	...
	public String toString() {
		return "RetencionFuentePorcentaje [sriRetFuCodigo=" + sriRetFuCodigo + ", codigo=" + codigo
				+ ", codigoInstitucionControl=" + codigoInstitucionControl + ", descripcion=" + descripcion
				+ ", porcentaje=" + porcentaje + ", deCada=" + deCada + ", valor=" + valor + ", fechaDesde="
				+ fechaDesde + ", fechaHasta=" + fechaHasta + ", estado=" + estado + ", fechaEstado=" + fechaEstado
	...
	public int hashCode() {
		...
		result = prime * result + sriRetFuCodigo;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RetencionFuentePorcentaje other = (RetencionFuentePorcentaje) obj;
		...
		if (porcentaje != other.porcentaje)
			return false;
		if (sriRetFuCodigo != other.sriRetFuCodigo)
			return false;
	...
	public static void setFormatter(SimpleDateFormat formatter) {
		RetencionFuentePorcentaje.formatter = formatter;
	}
	public int getSriRetFuCodigo() {
		return sriRetFuCodigo;
	}
	public void setSriRetFuCodigo(int sriRetFuCodigo) {
		this.sriRetFuCodigo = sriRetFuCodigo;
	}
